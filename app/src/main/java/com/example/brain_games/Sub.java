...
//                    }
                    btnPlayAgain.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Intent intent= new Intent(Sub.this,Multiple.class);
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mysong = MediaPlayer.create(com.example.brain_games.Sub.this, R.raw.wrong);
            mysongs = MediaPlayer.create(com.example.brain_games.Sub.this, R.raw.right);
