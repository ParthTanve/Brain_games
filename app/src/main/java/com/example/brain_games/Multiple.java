...
//                }
                btnPlayAgain.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent= new Intent(Multiple.this,Gameone.class);
...
//        imagea = (ImageView) findViewById(R.id.imagew);
        buttona = (Button) findViewById(R.id.wmute);
        mysong = MediaPlayer.create(com.example.brain_games.Multiple.this, R.raw.wrong);
        mysongs = MediaPlayer.create(com.example.brain_games.Multiple.this, R.raw.right);
